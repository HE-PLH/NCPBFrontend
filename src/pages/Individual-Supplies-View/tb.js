                    ...
                    <Table>
                        ...
                        <TableBody>
                            {filteredUsers
                                ...
                                .map((row) => {
                                    const {_id, Id, Name, EntryPrice, Price, Quantity, Units, SupplyId, DeliveredQuantity, InvoiceStatus, DeliveryStatus, PaymentStatus, Date, Time, Status, Image, ThumbUrl} = row;
