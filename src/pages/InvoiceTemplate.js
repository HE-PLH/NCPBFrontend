...
export default function InvoiceTemplate() {
        ...
        items.map((Id) => {
            axios.get("http://127.0.0.1:9000/api/individualsupplies?_id="+Id).then((response) => {
                ...
                if (counter===len){
                    ...
                    setDeliveryId(temp[0].DeliveryNumber);
    ...
    const _print = ()=>{
        ...
        let lst = [ "_date", "_time", "_invoiceId", "_clientName", "_phoneNumber", "_location", "_targetDepartment", "_box", "_total", "_subTotal", "_VAT", "_VATPerc", "_discount", "_inclusive", "_LPONumber", "_deliveryId"];
        ...
        for (let i = 0; i < lst.length; i++) {
            switch (lst[i]) {
                ...
                case "_phoneNumber":
                    ...
                    break;
                case "_deliveryId":
                    form_data["DeliveryNumber"] = document.querySelector(`.${lst[i]}`).value;
                    break;
