...
export default function SuppliesView(props) {
    ...
    const [table_head, setTableHead] = useState([
        ...
        {id: 'SiteId', label: 'SiteId', defaultValue: {Id: props._SiteId}, alignRight: false},
        {id: 'TargetDepartment', label: 'TargetDepartment', alignRight: false},
    ...
    useEffect(() => {
        axios.get("http://127.0.0.1:9000/api/supplies?SiteId=" + props._SiteId).then((response) => {
