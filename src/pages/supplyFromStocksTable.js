    ...
    return (
        ...
        <Card>
            <UserListToolbar
                ...
                selected={selected}
                confirmStocks={true}
                confirmStocksFunction={props.confirmItems}
                    ...
                    <Table className={"p-table"}>
                        ...
                        <TableBody className={"editted-items"}>
                            {filteredUsers
                                ...
                                .map((row) => {
                                    const {_id, Description , Amount, Quantity, Price, Units} = row;
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <TableCell align="left" padding={"none"}><input
