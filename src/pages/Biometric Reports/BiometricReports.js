...
import {AppBugReports, AppItemOrders, AppNewUsers, AppWeeklySales} from "../../sections/@dashboard/app";
...
export default function BiometricReports(props) {
    ...
    function onDatesChange() {
        dates.startDate ?
            axios.post("http://127.0.0.1:9000/api/periodicLogs", {
                ...
                <Box className={"petty-print"}>
                    ...
                    <Stack direction="row" className={"print-top-row centered"} alignItems="center"
                        ...
                        <Typography className={"subtitle2"} variant="subtitle2" gutterBottom>
                                WEEKLY ATTENDANCE REPORT FOR HEAD OFFICE STAFF
                            </Typography>
                    </Stack>

                    <DailyPettyCashSummaryTable list={list} tableHead={table_head} timeTableHead={time_table_head}
                                                viewFunction={(e) => {
                                                    viewItem(e)
                                                }}/>
                </Box>
